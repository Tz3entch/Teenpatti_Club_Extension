...
import su.sfs2x.extensions.games.teenpatticlub.utils.Appmethods;
 ...
 public class PlayerBean
 {
   ...
   private Integer timerBank = Integer.valueOf(1);
   ...
   public ISFSObject getSessionSfsObject() {
     ...
     {
       total += ((Float)this.amounts.get(i)).floatValue();
     }
   ...
   public void setAutoPlay(boolean isAutoPlay) { this.isAutoPlay = isAutoPlay; }
   
   public float getStartInplay() {
     return this.startInplay;
   }
   
   public void setStartInplay(float startInplay) { this.startInplay = startInplay; }
   
   public ArrayList<Float> getAmounts() {
     return this.amounts;
   }
   
   public void setAmounts(ArrayList<Float> amounts) { this.amounts = amounts; }
   ...
   public void setWonHands(int wonHands) { this.wonHands = wonHands; }
   ...
   public void setTimeUpCount(int timeUpCount) { this.timeUpCount = timeUpCount; }
   ...
   public void setUsingExtraTime(boolean isUsingExtraTime) { this.isUsingExtraTime = isUsingExtraTime; }
   ...
   public void setInplay(float inplay) { this.inPlay = Appmethods.setFloatFormat(inplay); }
   
   public Integer getTimerBank() {
     return this.timerBank;
   }
   
   public void setTimerBank(Integer timerBank) { this.timerBank = timerBank; }
 }
